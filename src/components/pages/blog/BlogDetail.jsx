        ...
        <main className="flex-grow flex items-center justify-center mt-16">
          <div className="text-center">
            ...
            <div className="space-x-4">
              <button 
                className="bg-yellow-500 text-white px-6 py-2 rounded hover:bg-yellow-700 transition"
    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 space-y-6 sm:space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-6 sm:pt-8 border-t gap-4" data-aos="fade-up">
          <button
            onClick={() => navigate('/blog')}
            className="flex items-center gap-2 text-yellow-500 hover:text-yellow-700 transition text-sm sm:text-base"
          >
            ← Back to Blogs
          </button>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
            ...
            {nextBlog && (
              <button
                ...
                className="bg-yellow-500 text-white px-3 sm:px-4 py-2 rounded hover:bg-yellow-700 transition text-xs sm:text-sm"
              >
                Next →
              </button>
            )}
